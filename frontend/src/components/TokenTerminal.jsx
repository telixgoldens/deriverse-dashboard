        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-white font-black text-lg flex items-center gap-2">
                {token.symbol} / USD
                <span className="text-[10px] bg-[#00f0ff]/10 text-[#00f0ff] px-2 py-0.5 rounded border border-[#00f0ff]/20">
                  PERP
                </span>
              </h2>
            </div>
          ...
          <div className="hidden md:flex gap-6 ml-8 border-l border-[#2A2F3A] pl-8">
            <div>
              ...
              <p
                className={`text-sm font-mono font-bold ${TERMINAL_DATA.change24h >= 0 ? "text-green-400" : "text-red-400"}`}
              >
          ...
          <div className="p-6 space-y-6 flex-1 overflow-y-auto">
            ...
            <div className="space-y-2 py-4 border-t border-b border-[#2A2F3A]">
              ...
              <div className="flex justify-between text-[10px]">
                ...
                <span className="text-orange-400 font-mono">
                  $
                  {(side === "long"
                    ? TERMINAL_DATA.price * 0.9
                    : TERMINAL_DATA.price * 1.1
                  ).toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between text-[10px]">
            ...
            <div className="bg-gradient-to-r from-purple-900/20 to-blue-900/20 p-4 rounded-xl border border-purple-500/20">
              ...
              <p className="text-[10px] text-gray-300 leading-relaxed">
                High probability of squeeze. 65% of recent volume is on the
                short side. A Long here aligns with 4H trend.
              </p>
            </div>
          </div>
