  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-[#0B0E11] rounded-[30px] shadow-[0_0_50px_rgba(0,240,255,0.15)] max-w-lg w-full p-8 border border-[#2A2F3A] animate-in fade-in zoom-in duration-200">
        <button
          onClick={onClose}
